...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MZDownloadManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17MZDownloadManager17MZDownloadManager")
...
@interface MZDownloadManager (SWIFT_EXTENSION(MZDownloadManager)) <NSURLSessionDownloadDelegate>
...
@interface MZDownloadManager (SWIFT_EXTENSION(MZDownloadManager))
- (void)addDownloadTask:(NSString * _Nonnull)fileName request:(NSURLRequest * _Nonnull)request destinationPath:(NSString * _Nonnull)destinationPath;
...
- (void)addDownloadTask:(NSString * _Nonnull)fileName request:(NSURLRequest * _Nonnull)request;
...
SWIFT_PROTOCOL("_TtP17MZDownloadManager25MZDownloadManagerDelegate_")
...
SWIFT_CLASS("_TtC17MZDownloadManager15MZDownloadModel")
...
SWIFT_CLASS("_TtC17MZDownloadManager9MZUtility")
...
+ (NSNumber * _Nullable)getFreeDiskspace SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
